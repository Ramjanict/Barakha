...
const ProductForm = ({ onSubmit, isLoading = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-10 flex items-center justify-center min-h-screen transition-opacity bg-opacity-50 backdrop-blur-sm">
      <form
        onSubmit={handleSubmit(submitHandler)}
        className="max-w-4xl bg-white p-4  rounded-xl    flex flex-col  gap-6  shadow-[0px_0px_1px_2px_rgba(0,0,0,.04)]"
      >
